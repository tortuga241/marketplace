...
// components/UI/profile/profileSellerComp.js (Ваш оригинальный ProfileSellerComp)
...
export default function ProfileSellerComp({ user, shop, isOwner }) { // <--- Принимаем props
